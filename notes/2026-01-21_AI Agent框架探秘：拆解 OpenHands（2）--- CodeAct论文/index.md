...
* 再比如，Browser Use 的 bu-agent-sdk 的设计理念及其简单：Agent就是一个for循环。核心代码只有几行：不断调用LLM，执行工具，把结果塞回上下文。框架作者Gregor Zunic在推文中直言："所有价值都在RL过的模型里，不在你那上万行的抽象里。"  
  ![bu-agent-loop](images/img_001.png)
...
![react_sequence](images/img_002.png)
...
![OpenHands-CodeAct-对比](images/img_003.jpg)
...
![OpenHands-CodeAct-Overview](images/img_004.jpg)
...
![CodeActPrompt](images/img_005.jpg)
...
![Programmatic Tool Calling](images/img_006.png)
