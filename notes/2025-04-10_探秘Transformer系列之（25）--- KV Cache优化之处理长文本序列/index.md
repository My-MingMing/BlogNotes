...
* SubGen是一种为 KV cache开发的高效压缩技术。经验证据表明，attention模块中的关键嵌入存在显著的聚类趋势。基于这一关键见解，SubGen设计了一种具有亚线性复杂度的新颖缓存方法，对关键token采用在线聚类并对值进行在线*ℓ* (2)采样。
...
[大模型推理优化技术-KV Cache](https://zhuanlan.zhihu.com/p/700197845) [吃果冻不吐果冻皮](<https://www.zhihu.com>  
