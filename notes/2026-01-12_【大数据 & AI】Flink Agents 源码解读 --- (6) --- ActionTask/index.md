...
| Tool 相关机制 | 支持装饰器（@tool）、add\_resource 等方式注册工具，通过 TOOL\_CALL\_ACTION 触发执行 |

在系统中的架构如下

![flink-6-1](images/img_001.png)
...
![Flink-6-3](images/img_003.png)

#### 1.3.3 与其他组件的关系

PythonActionTask 与其他组件的关系如下图所示。

![Flink-6-4](images/img_004.png)
