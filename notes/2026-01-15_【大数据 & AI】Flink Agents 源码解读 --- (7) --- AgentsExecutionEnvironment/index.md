...
| 特色维度 | 具体说明 |
| --- | --- |
| 环境适配性 | 专门面向 Flink 集群的**远程执行**场景设计，依赖 Flink 的流执行环境（StreamExecutionEnvironment）和表环境（StreamTableEnvironment），而非本地执行； |
...
![Flink-7-1](images/img_001.png)

详细交互流程如下：

1. 初始化阶段

![Flink-7-2](images/img_002.png)

2. 运行时事件处理流程

![Flink-7-3](images/img_003.png)
