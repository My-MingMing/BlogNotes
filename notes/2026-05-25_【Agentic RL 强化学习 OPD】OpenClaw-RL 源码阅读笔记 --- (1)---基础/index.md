...
* **开源代码链接**：<https://github.com/Gen-Verse/OpenClaw-RL>
...
![openclawRL-compare](images/img_002.png)
...
![openclawRL_Binary_RL](images/img_003.jpg)
...
![openclawRL_OPD](images/img_004.jpg)
...
| --- | --- | --- | --- |
| **信号来源** | next\_state 隐式 | next\_state 显式指令 | 两者皆有 |
| **优势计算** | A\_t = scalar（全 response 统一） | A\_t=`logπ_teacher−logπ_student`（per-token 粒度） | A\_t=w\_rl⋅r+w\_opd⋅(teacher−student) |
...
| --- | --- | --- |
| **主要 reward** | PRM（LLM judge 解读 next\_state） | 环境直接返回（exit code / 答案正确性） |
