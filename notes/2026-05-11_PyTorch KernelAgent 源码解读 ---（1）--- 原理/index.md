...
![KernelBench-输入](images/img_001.png)
...
![KernelBench-输出](images/img_002.png)
...
![KernelBench-pipeline](images/img_003.png)
...
Kevin-32B（ <https://arxiv.org/pdf/2507.11948> ）由*Stanford Cognition AI* 实验室提出，生成语言为 CUDA，基座模型是 QwQ-32B，在 KernelBench L1 和 L2 级别展开实验。
...
![CUDA-L1-training](images/img_004.png)
...
![inference-time-scaling-deepseek-r1-hopper-1536x499](images/img_005.png)
...
| **硬件感知智能体** | 实时采集目标 GPU 硬件信息，生成标准化硬件报告，提炼核心优化约束 | `torch.cuda` API、`nvidia-smi`、NVIDIA 硬件特性映射库 | 向策略制定智能体输出「硬件信息 + 优化约束」 |
