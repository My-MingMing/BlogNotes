...
![cookbook-chapter3-chart](images/img_001.png)
...
*论文链接: [https://arxiv.org/pdf/2507.03724](https://link.zhihu.com/?target=https%3A//arxiv.org/pdf/2507.03724)*
...
![memos-architecture](images/img_002.png)
...
![memos-1-1](images/img_003.png)

##### 加载流程

![memos-1-2](images/img_004.png)

##### 存储流程

![memos-1-3](images/img_005.png)
...
| --- | --- | --- | --- |
| 精准度 | 语料越多，噪声越大 | 通过生产阶段的抽取、图式化/关系建模，再配合调度与生命周期管理，形成结构化组织，记忆条理更清晰    能够基于用户反馈驱动自我进化 | **更准**：减少噪声，降低幻觉 |
