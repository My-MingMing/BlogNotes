...
\[q\_i = x\_i \mathbf{W}^Q \\
k\_i = x\_i \mathbf{W}^K \\
v\_i = x\_i \mathbf{W}^V \\
\]
...
\[attention(q,k,v) = W\_v\ (tanh(W\_k + W\_q)) \ [相加] \\
attention(q,k,v) = W\_v\frac{(W\_q)(W\_k^T)}{\sqrt d}\ [相乘]
\]
...
\[softmax(x\_{max}) \approx \frac{1}{1} = 1 \\
softmax(x\_i) \approx 0 \ \ \ \ \ i \neq max
\]
...
[How Do Language Models put Attention Weights over Long Context](https://lyaofu.notion.site/How-Do-Language-Models-put-Attention-Weights-over-Long-Context-10250219d5ce42e8b465087c383a034e)<https://lyaofu.notion.site/How-Do-Language-Models-put-Attention-Weights-over-Long-Context-10250219d5ce42e8b465087c383a034e>)
